...
use parserc::{ControlFlow, Parser as _, keyword, next_if, syntax::Syntax, take_till, take_while};
    ...
    I: crate::input::CSTInput,
{
    ...
    fn parse(input: &mut I) -> Result<Self, <I as parserc::Input>::Error> {
        ...
        next_if(|c: u8| c == b'_' || c.is_ascii_alphabetic())
            .parse(input)
            .map_err(crate::errors::SyntaxKind::Ident.map())?;
    ...
    I: crate::input::CSTInput,
{
    ...
    fn parse(input: &mut I) -> Result<Self, <I as parserc::Input>::Error> {
        ...
        next_if(|c: u8| c == b'_' || c == b'-' || c.is_ascii_alphabetic())
            .parse(input)
            .map_err(crate::errors::SyntaxKind::XmlIdent.map())?;
